...
- [OrlovEvgeny/serde.zig](https://github.com/OrlovEvgeny/serde.zig) - Comptime serialization framework for Zig - serialize and deserialize any type across JSON, MessagePack, TOML, YAML, ZON, and CSV.
