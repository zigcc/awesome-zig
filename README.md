...
- [atman/zg](https://codeberg.org/atman/zg) - The zg provides Unicode text processing for Zig projects. It works correctly with the Russian language and other languages.
