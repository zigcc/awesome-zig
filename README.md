...
- [mitchellh/libxev](https://github.com/mitchellh/libxev) - libxev is a cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
- [Fun](https://github.com/omdxp/fun) - Fun is a statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
...
- [wazm](https://github.com/fengb/wazm) - wazm — WebAssembly Zig Machine.
